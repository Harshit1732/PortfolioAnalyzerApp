...
public class AlphavantageService implements StockQuotesService {
  ...
  private static final AlphavantageCandle NULL = null;
  ...
  public List<Candle> getStockQuote(String symbol, LocalDate from, LocalDate to)
      throws JsonProcessingException, StockQuoteServiceException {
        ...
        try{
        String url = buildUri(symbol,  getToken());
        String apiresponse= restTemplate.getForObject(url, String.class);
        
        ObjectMapper om= getObjectMapper();

        Map<LocalDate, AlphavantageCandle>candles= om.readValue(apiresponse, AlphavantageDailyResponse.class).getCandles();
  ...
  protected static String getToken() {
    String token = "AYZTA6BS92CGNONC";
    return token;
  }

  protected static String buildUri(String symbol,
  String token) {
    String uriTemplate = "https://www.alphavantage.co/query?function=TIME_SERIES_DAILY&symbol="+ symbol+"&output=full&apikey="+token+"";
    return uriTemplate;
}
